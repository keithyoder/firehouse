...
class MemberTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create member_type" do
    assert_difference('MemberType.count') do
      post member_types_url, params: { member_type: { department_id: @member_type.department_id, type: @member_type.type } }
    end
  ...
  test "should update member_type" do
    patch member_type_url(@member_type), params: { member_type: { department_id: @member_type.department_id, type: @member_type.type } }
